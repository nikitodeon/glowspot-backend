...
export const MESSAGES = {
	welcome:
		`<b>👋 Добро пожаловать в Glowspot Bot!</b>\n\n` +
		`Чтобы получать уведомления и улучшить ваш опыт использования платформы, давайте свяжем ваш Telegram аккаунт с Glowspot.\n\n` +
		`Нажмите на кнопку ниже и перейдите в раздел <b>Уведомления</b>, чтобы завершить настройку.`,
	authSuccess: `🎉 Вы успешно авторизовались и Telegram аккаунт связан с Glowspot!\n\n`,
	...
	resetPassword: (token: string, metadata: SessionMetadata) =>
		`<b>🔒 Сброс пароля</b>\n\n` +
		`Вы запросили сброс пароля для вашей учетной записи на платформе <b>Glowspot</b>.\n\n` +
		`Чтобы создать новый пароль, пожалуйста, перейдите по следующей ссылке:\n\n` +
		`<b><a href="https://glowspot.ru/account/recovery/${token}">Сбросить пароль</a></b>\n\n` +
		...
		`Спасибо за использование <b>Glowspot</b>! 🚀`,
	deactivate: (token: string, metadata: SessionMetadata) =>
		...
		`Спасибо, что пользуетесь <b>Glowspot</b>! Мы всегда рады видеть вас на нашей платформе и надеемся, что вы останетесь с нами. 🚀\n\n` +
		`С уважением,\n` +
		`Команда Glowspot`,
	accountDeleted:
		...
		`<b><a href="https://glowspot.ru/account/create">Зарегистрироваться в Glowspot</a></b>\n\n` +
	...
	enableTwoFactor:
		...
		`Включите двухфакторную аутентификацию в <a href="https://glowspot.ru/dashboard/settings">настройках аккаунта</a>.`
}
